...
var SelectionTitle = React.createClass({
    ...
    render: function () {
        ...
        var item = this.props.item.map((function (items, index) {
            ...
            return React.createElement(SelectionItem, { key: "SelectionItem" + index,
                content: items.item,
                number: items.number,
                checked: this.state.checked
            });
...
var LeftPanel = React.createClass({
    ...
    render: function () {
        ...
        var chooseNode = titles.map((function (title, index) {
            return React.createElement(SelectionTitle, { key: "selectionTitle" + index,
                content: title,
                item: itemsSort[title],
                count: itemsCount[title],
                checked: this.state.checked
            });
        }).bind(this));
...
ReactDOM.render(React.createElement(LeftPanel, { content: [{
        "id": 1,
        "title": "工程研发部门",
        "item": "Mac 开发工程师",
        "checked": "false",
